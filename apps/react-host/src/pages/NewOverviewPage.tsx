          ...
          <div className="overview-dash__main">
            ...
            <section className="overview-dash__videos" aria-label="演示视频">
              {[
                ...
                <article key={item.title} className="overview-card overview-dash__video-card">
                  <div className="overview-dash__video-frame" role="img" aria-label={`${item.title}，${item.hint}`}>
                    <span className="overview-dash__video-placeholder-title">{item.title}</span>
                    <span className="overview-dash__video-placeholder-hint">{item.hint}</span>
                  </div>
                </article>
              ))}
            </section>
